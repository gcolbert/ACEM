...
public class PedagogicalAndDocumentaryResourceNode extends ResourceNode implements PedagogicalAndDocumentaryResource {
	...
	public PedagogicalAndDocumentaryResourceNode() {
	}

	public PedagogicalAndDocumentaryResourceNode(String name, String iconFileName) {
		this();
		setName(name);
