...
public interface PedagogicalScenarioRepository extends GenericRepository<PedagogicalScenarioNode> {
	...
	@Query(value = "MATCH (a:PedagogicalAnswer)-[:answeredUsingResourceCategory]->(:ResourceCategory)<-[:activityRequiringResourceFromCategory]-(:PedagogicalActivity)-[:activityForSession]->(ses:PedagogicalSession)-[:sessionForSequence]->(seq:PedagogicalSequence)-[:sequenceForScenario]->(sce:PedagogicalScenario) WHERE id(a)=({pedagogicalAnswerId}) RETURN sce UNION ALL MATCH (a:PedagogicalAnswer)-[:answeredUsingResourceCategory]->(:ResourceCategory)<-[:activityRequiringResourceFromCategory]-(:PedagogicalActivity)-[:activityForSequence]->(seq:PedagogicalSequence)-[:sequenceForScenario]->(sce:PedagogicalScenario) WHERE id(a)=({pedagogicalAnswerId}) RETURN sce")
	Set<PedagogicalScenarioNode> findScenariosAssociatedWithPedagogicalAnswer(@Param("pedagogicalAnswerId") Long id);

	@Query(value = "MATCH (c:ResourceCategory)<-[:activityRequiringResourceFromCategory]-(:PedagogicalActivity)-[:activityForSession]->(ses:PedagogicalSession)-[:sessionForSequence]->(seq:PedagogicalSequence)-[:sequenceForScenario]->(sce:PedagogicalScenario) WHERE id(c)=({resourceCategoryId}) RETURN sce UNION ALL MATCH (c:ResourceCategory)<-[:activityRequiringResourceFromCategory]-(:PedagogicalActivity)-[:activityForSequence]->(seq:PedagogicalSequence)-[:sequenceForScenario]->(sce:PedagogicalScenario) WHERE id(c)=({resourceCategoryId}) RETURN sce")
