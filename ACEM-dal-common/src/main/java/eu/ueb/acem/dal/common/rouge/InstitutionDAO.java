 ...
 * care of beans that implement the Institution interface.
 * 
 * @param <ID>
 ...
 * @since 2015-11-19
 */
public interface InstitutionDAO<ID> extends OrganisationDAO<ID, Institution> {

	/**
	 * Returns the Institution instance that have a supannEtablissement property
	 ...
	 * @return the Institution with the given "supannEtablissement" value, or
	 *         null
	 */
	Institution retrieveBySupannEtablissement(String supannEtablissement);
