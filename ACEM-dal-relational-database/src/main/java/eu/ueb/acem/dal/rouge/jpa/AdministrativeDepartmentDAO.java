...
public class AdministrativeDepartmentDAO extends AbstractDAO<AdministrativeDepartment, AdministrativeDepartmentEntity> implements OrganisationDAO<Long, AdministrativeDepartment> {
